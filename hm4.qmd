...
# Step 4: Compute h using the vectors u and v
h_result <- calculate_h(vector_u, vector_v)

# Step 5: Compute the gradient of h with respect to u
h_result$backward()

# Step 6: Access and print the gradient of h with respect to u
